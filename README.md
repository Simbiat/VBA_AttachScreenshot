...
Sadly, this code will not work on Shared Workbooks, since Charts do not work there. The only alternative solution I've found so far is to resize the apsted image to cell same as Chart is resized in this code.
